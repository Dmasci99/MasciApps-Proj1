<%@ Page Title="About Me" Language="C#" MasterPageFile="~/Interior.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="MasciApps_Proj1.About" %>
<%-- 
/**
...
* Website Name : DanMasci.azurewebsites.net/About.aspx
* 
* The Following page is the Content for the "About" page.
*/ 
--%>
